                ...
                <div class="card-body">
                  ...
                  <input type="hidden" id="id" name="id" value="<?php echo (isset($data->id)?$data->id:""); ?>">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="number" class="form-control" id="harga" name="harga" placeholder="Rp.xxx"  value="<?php echo(isset($data->harga)?$data->harga:"");?>">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="exampleInputEmail1">Jenis </label>
                      <input type="text" class="form-control" id="jenis" name="jenis" placeholder="Makanan/Minuman"   value="<?php echo(isset($data->jenis)?$data->jenis:"");?>">
                    </div>
                   <!-- <div class="col-md-6">
