                ...
                <div class="card-body">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                      <label>Tanggal Lahir</label>
                        <div class="input-group date">
                            <input id="tglmasuk" type="text" class="form-control datepicker" name="tgl" value="<?php echo (isset($data->tgl)?$data->tgl:""); ?>" required/>
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <select id="selectexhibit" name="id_kandang" class="form-control" style="width: 100%;">
                      <option value=<?php echo (isset($data->id_kandang)?$data->id_kandang:"")?> selected><?php echo (isset($data->kandangexhibit->kode_kandang)?$data->kandangexhibit->kode_kandang:"")?></option>
                      </select>
                    </div>
                    <div class="form-group col-md-6">
                      <label>Lokasi Kandang Holding</label>
                      <select id="selectholding" name="id_kandang" class="form-control" style="width: 100%;">
                      <option value=<?php echo (isset($data->id_kandang)?$data->id_kandang:"")?> selected><?php echo (isset($data->kandangexhibit->kode_kandang)?$data->kandangexhibit->kode_kandang:"")?></option>
                      </select>
                    </div>
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" id="asalusul" name="asalusul">
                          <option <?php echo (isset($data->asalusul)&&$data->asalusul=="Captive Breed"?"selected":""); ?> value="Captive Breed">Captive Breed</option>
                          <option <?php echo (isset($data->asalusul)&&$data->asalusul=="Satwa Hibah"?"selected":""); ?> value="Satwa Hibah">Satwa Hibah</option>
                          <option <?php echo (isset($data->asalusul)&&$data->asalusul=="Breeding Loan"?"selected":""); ?> value="Breeding Loan">Breeding Loan</option>
                          <option <?php echo (isset($data->asalusul)&&$data->asalusul=="Titip Rawat"?"selected":""); ?> value="Titip Rawat">Titip Rawat</option>
                          <option <?php echo (isset($data->asalusul)&&$data->asalusul=="Perolehan Lainnya"?"selected":""); ?> value="Perolehan Lainnya">Perolehan Lainnya</option>
                        </select>
                      </div>
                    </div>
                    <div class="form-group col-md-6">
                      <label for="exampleInputEmail1">Instansi </label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nama Instansi" name="nama_instansi" value="<?php echo (isset($data->nama_instansi)?$data->nama_instansi:""); ?>">
                    </div>
                    <div class="form-group col-md-6">
                      <label>Tanggal Lahir</label>
                        <div class="input-group date">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                          ...
                          <textarea name="ciri" class="form-control" rows="3" placeholder="Enter ..."></textarea>
                        </div>
                    </div>
                    <div class="row">
